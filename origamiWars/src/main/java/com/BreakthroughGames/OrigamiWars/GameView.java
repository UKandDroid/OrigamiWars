...
************************************************************************************************************************/
	...
	@Override public void onSurfaceChanged(GL10 gl, int width, int height) {
		Values.log("MethodCall", "GameView::OnSurfaceChanged() ");
	...
	@Override public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		Values.log("MethodCall", "GameView::OnSurfaceCreated() ");
		Draw.gl = gl;
...
************************************************************************************************************************/
	protected void startGame(GL10 glRef) {
        Values.log("MethodCall", "GameView::startGame() ");
		...
		switch(Game.iMode) {
			...
			case Values.STORY_RESUME_LEVEL:	
				Values.log("GameStats", "Game not Loaded : Starting now");
