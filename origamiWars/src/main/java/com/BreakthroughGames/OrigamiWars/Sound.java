...
public class Sound extends Service									// Class to Handle Music, run as a service
{
 ...
 // static final int CRUISE			= 23;
    ...
    static final int BG_MUSIC_LEVEL1 = 60;			
    static final int BG_MUSIC_LEVEL2 = 61;
    static final int BG_MUSIC_LEVEL3 = 62;
    static final int BG_MUSIC_LEVEL4 = 63;
    static final int BG_MUSIC_LEVEL5 = 64;
    static final int BG_MUSIC_INTRO  = 65;
	...
	@Override	public void onLowMemory(){ player.stop(); }				
	...
	@Override public IBinder onBind(Intent arg0){ return mMsn.getBinder();	}
...
************************************************************************************************************************/
	private static void BGPause()	{	if(player != null)	player.pause();	}
	private static void BGStop()	{	if(player != null)	player.stop(); }
	private static void BGPlay()	{	try	{ player.start(); player.setVolume(iCurVolume, iCurVolume);} catch(Exception e)	{ e.printStackTrace(); player.stop(); }	}
...
************************************************************************************************************************/
	...
	private static void soundCommand(int vCommand, int vSound, int vExtra)
	{
		switch(vCommand)
			{
			case SOUND_STOP: 		soundStop(vSound);					break;
			case SOUND_PAUSE_ALL:  	sPool.autoPause();					break;
			case SOUND_RESUME_ALL: 	sPool.autoResume();					break;
			case SOUND_STOP_ALL: 	for(int i=0; i < MAX_STREAMS ; i++) sPool.stop(arrStreams[i][STREAM_ID]);	break;
	...
	static class IncomingHandler extends Handler
	{
		@Override public void handleMessage(Message msg)
		{
			if(msg.what < MAX_SOUNDS)	
				...
				{
				case BG_MUSIC_PLAY: 	BGPlay(); 	break;
				case BG_MUSIC_PAUSE: 	BGPause(); 	break;
				case BG_MUSIC_STOP:		BGStop(); 	break;
				case BG_SET_VOLUME:		setVolume(msg.arg1, msg.arg2); 			break;
				case BG_MUSIC_LEVEL1: 	BGSet(R.raw.level1);	BGPlay();		break;
				case BG_MUSIC_LEVEL2: 	BGSet(R.raw.level2);	BGPlay();		break;
				case BG_MUSIC_LEVEL3: 	BGSet(R.raw.level3);	BGPlay();		break;
				case BG_MUSIC_LEVEL4: 	BGSet(R.raw.level4);	BGPlay();		break;
				case BG_MUSIC_LEVEL5: 	BGSet(R.raw.level5);	BGPlay();		break;
				case BG_MUSIC_INTRO: 	BGSet(R.raw.intro);		BGPlay();		break;
				case SOUND_STOP: case SOUND_PAUSE_ALL:	case SOUND_RESUME_ALL:  case SOUND_STOP_ALL: case SOUND_SET_VOLUME:
