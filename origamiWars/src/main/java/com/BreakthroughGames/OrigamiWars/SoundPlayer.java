...
public class SoundPlayer {
     ...
     ************************************************************************************************************************/
    public static void playSound(final int vSound) {
        playSound(vSound, 0, 0);
    }

    protected static void playSound(final int vSound, final float vOverLap) {
        playSound(vSound, vOverLap, 0);
    }
     ...
     *	METHOD -- Set BG Music
     ************************************************************************************************************************/
    public static void setVolume(float vMulty, float vBGBase) {
        if (bBound) {
            if (vBGBase > 0.0f)
     ...
     ************************************************************************************************************************/
    protected static void sendCommand(int vCmnd) {
        sendCommand(vCmnd, 0, 0);
    }
