...
{	
	private class Event
	{
		...
		public Event( int vPriority, int vTimesRun,  int vDisplayTime, int vLineStart, boolean vPause, float vOverlap, int vSound,  long[] vaVibrate)
					{ iPriority = vPriority; iTimesRun = vTimesRun; iDisplayTime = vDisplayTime; iLineStart = vLineStart; bPause = vPause; fOverlap= vOverlap; iSound = vSound; aVibrate = vaVibrate;}
	}

	protected int iTimer;												// Timer to sync event and other things
	...
	protected static final int SURVIVE 			= 1;					// Event with GUI, Events Texture
	protected static final int TOUCH_TO_MOVE 	= 2;
	protected static final int TOUCH_TO_FIRE	= 3;
	protected static final int BLOW_ON_SCREEN	= 4;
	protected static final int FLICK_TO_ROLL 	= 5;
	protected static final int FLICK_TO_SWAVE 	= 6;
	protected static final int SWITCH_WEAPON 	= 7;
	protected static final int LEVEL_COMPLETE 	= 8;
	protected static final int GAME_OVER 		= 9;
	...
	protected static final int SCORE 			= 13;
	...
	protected static final int STAGE1_LEVEL2 	= 22;
	protected static final int STAGE1_LEVEL3	= 23;
	protected static final int STAGE2_LEVEL1 	= 24;
	protected static final int STAGE2_LEVEL2 	= 25;
	protected static final int STAGE2_LEVEL3 	= 26;
	protected static final int STAGE3_LEVEL1 	= 27;
	protected static final int STAGE3_LEVEL2 	= 28;
	protected static final int STAGE3_LEVEL3 	= 29;
...
***********************************************************************************************************************/
	...
	public void draw()
	{
		if(!bEnable || Screen.iMenu != Screen.MENU_OFF)	return; 										// If no event or menu is displayed, dont do anything
...
***********************************************************************************************************************/
	protected void dispatch(final int vEvent)
	{
		...
		if(vEvent > LAST_GUI_EVENT)											// Event Doesn't have any Text or GUI
			...
			{
			if(eve.iTimesRun > 0)	eve.iTimesRun--;						// If Event has set number of times, reduce one
