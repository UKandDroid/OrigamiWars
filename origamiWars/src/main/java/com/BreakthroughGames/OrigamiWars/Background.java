...
public class Background extends Draw{	
	...
	protected float scrollY = 0f; 															//Position of Object 
	...
	protected void loadTexture(int resTexture, int repeatOrClamp) { iSprite = 0; iTexture = Texture.getTxtId(resTexture, repeatOrClamp ); }
	protected void loadTexture(int resTexture) { iSprite = 0; iTexture = Texture.getTxtId(resTexture, GL10.GL_CLAMP_TO_EDGE ); }
